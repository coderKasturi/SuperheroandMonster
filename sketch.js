...
function setup() {
  ...
  box14 = new Box(797, 100, 70, 70);
  box15 = new Box(797, 100, 70, 70); 
  box16 = new Box(797, 100, 70, 70);
  box17 = new Box(797, 100, 70, 70);
  box18 = new Box(797, 100, 70, 70);
  box19 = new Box(797, 100, 70, 70);
  box20 = new Box(797, 100, 70, 70);
  box21 = new Box(797, 100, 70, 70);
